...
class BotArchitect:
    def __init__(self):
        self.codename = "Ph0enix"
        self.role = "Python Ninja & Bot Developer"
        self.tools = ["Python", "AsyncIO", "Telegram API", "Soroush API", "Redis", "MongoDB"]
        self.mission = "Building unstoppable automation and intelligent bots."
        self.motto = "Write once, run everywhere... preferably on a server!"
